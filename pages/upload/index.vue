<template>
    ...
    <UploadLayout>
        <div
            class="block mx-auto md:w-[1000px] w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4 flex text-center align-middle flex-wrap">


            <div class="mt-8 md:flex gap-6 flex-col justify-evenly">
                <div>
                ...
                <div class="md:flex flex-row">
                    <div v-if="!fileDisplay"
                        class="md:mr-10 mx-auto mt-4 mb-6  flex flex-col items-center justify-center w-full max-w-[260px] h-[470px] text-center p-3  border-2  border-dashed  border-gray-300  rounded-lg  hover:bg-gray-100 cursor-pointer">
                        <label for="fileInput" @drop.prevent="onDrop" @dragover.prevent="">
                    ...
                    <div v-else
                        class="md:mr-10 mx-auto mt-4 md:mb-12 mb-16 flex items-center justify-center w-full max-w-[260px] h-[540px] p-3 rounded-2xl cursor-pointer relative">
                    ...
                    <div class="mt-4 mb-6">
                        ...
                        <div class="mt-5">
                            ...
                            <input v-model="caption" maxlength="150" type="text"
                                class="w-full border p-2.5 rounded-md focus:outline-none text-gray-400">
                        </div>

                        <div class="flex gap-3 md:justify-start justify-center">
...
<script setup>
import UploadLayout from "~/.nuxt/layouts/UploadLayout.vue";
