<template>
    <div id="PostPage"
        ...
        <div class="lg:w-[calc(100%-540px)] h-full relative">
            ...
            <video v-if="true" :on-canplay="load()" class="absolute object-cover w-full my-auto z-[-1] h-screen"
                :src="src" />
            ...
            <div class="bg-black bg-opacity-70 lg:min-w-[480px]">
                <video v-if="true" :on-canplay="load()" ref="video" loop muted class="h-screen mx-auto" :src="src" />
            </div>
        </div>
                    ...
                    <div class="flex items-center relative w-full">
                        ...
                        <div class="ml-14 pt-0.5 w-full">
                            <div class="text-[18px] font-semibold flex items-center justify-between">
                                Eurwyn
                                <Icon v-if="true" @click="deleteComment($generalStore.selectedPost, comment.id)"
