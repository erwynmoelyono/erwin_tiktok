        ...
        <div class="pl-3 w-full px-4">
            ...
            <div class="mt-2.5 flex">
                <div @click="displayPost(post)"
                    ...
                    <video v-if="true" ref="video" loop muted class="rounded-xl object-cover mx-auto h-full"
                        src="/lilmosey.mp4" />
                    <img class="absolute right-2 bottom-14" width="90" src="~/assets/images/tiktok-logo.png">
                </div>
                <div class="relative mr-[75px]">
                    <div class="absolute bottom-0 pl-2">
                        <div class="pb-4 text-center">
                            ...
                            <span class="text-xs text-gray-800 font-semibold">{{ 3 }}</span>
                        </div>
